...
function playWord(gameId, playerId, word, cb) {
  ...
  // TODO: call dictionary.isValidWord
  // TODO: check the word against the game rules
}

// return letters played from the tray
function checkAgainstRules(gameId, playerId, word, cb) {

  // TODO: get the letters from the tray
  // TODO: call getLastTurn to get the last turn
  // TODO: if no last turn: can we make the word with the letters?
  // TODO: if last turn, can we make the word using either the first or last letter of that turn?
  // TODO: if we can't make the word, send an error
}
...
function getTurn(gameId, index, cb) {
  var turnKey = makeTurnKey(gameId);
  // TODO: return the specified turn using LINDEX
  // TODO: remember to parse the JSON
}
