...
function saveGame(gameId, game, cb) {
  ...
  // TODO: if game has sores, converty them to a string
...
function getGame(gameId, cb) {
  ...
  redis.hgetall(gameKey, function(err, game) { // see: https://github.com/mranney/node_redis#friendlier-hash-commands
    ...
    // TODO: if a game has scores, parse them from a string into an object
...
function gameOver(gameId, cb) {
  ...
  getGame(gameId, function(err, game) {
    ...
    // TODO: set score on game

    saveGame(gameId, game, cb);
  });
}
...
function calculateScores(gameId, cb) {
  ...
  // TODO: get all turns
  // TODO: for each player, calculate their score
  // TODO: return a hash containing each playerId -> score
