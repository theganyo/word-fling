...
function didLastPlayerGoOut(gameId, cb) {
  ...
  // TODO: get last turn
  // TODO: return true to cb if no letters in tray
}

function haveAllPlayersSkipped(gameId, cb) {

  // TODO: get the game
  // TODO: get the last round of turns
  // TODO: return true to cb if a complete round has occurred and none of the players played in the round
}

function gameOver(gameId, cb) {

  // TODO: get the game
  // TODO: set the game to inactive (active = false)
  // TODO: calculate the player scores
  // TODO: set the scores
  // TODO: save the game
  // later: add scores to leaderboard
  // later: notify players
}
